...
public class Soal8Activity extends AppCompatActivity {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case R.id.menu_utama:
                Intent i = new Intent (Soal8Activity.this, Main2.class);
                startActivity(i);
                return true;
            case R.id.trivia_quiz:
                Intent intent = new Intent (Soal8Activity.this, SelamatdatangquizActivity.class);
                startActivity(intent);
                return true;
            case R.id.about:
                Intent ab = new Intent (Soal8Activity.this, AboutusActivity.class);
                startActivity(ab);
                return true;
            case R.id.Settings:
                Intent is = new Intent (Soal8Activity.this, SettingActivity.class);
                startActivity(is);
                return true;
            case R.id.sign_out:
                Intent in = new Intent (Soal8Activity.this, Masuk.class);
                startActivity(in);
                break;
    ...
    private void logout() {
        mAuth.signOut();
        startActivity(new Intent(Soal8Activity.this, Masuk.class));
        finish();
    }
    @Override
    ...
    public void tampilDialog() {
        ...
        builder.setMessage("Jawaban kamu benar : Patrilineal");
        builder.setPositiveButton("OKE", new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialogInterface, int i) {
                Toast.makeText(Soal8Activity.this, "Selamat", Toast.LENGTH_SHORT).show();
                Intent intent = new Intent(Soal8Activity.this, Soal9Activity.class);
                Soal8Activity.this.startActivity(intent);
            }
        });
    ...
    public void jawabanSalah(){
        ...
        builder.setPositiveButton("LEWATI", new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialogInterface, int i) {
                Toast.makeText(Soal8Activity.this, "Coba Lagi", Toast.LENGTH_SHORT).show();
                Intent intent = new Intent(Soal8Activity.this, Soal9Activity.class);
                Soal8Activity.this.startActivity(intent);
            }
        });
