...
public class Soal7Activity extends AppCompatActivity {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case R.id.menu_utama:
                Intent i = new Intent (Soal7Activity.this, Main2.class);
                startActivity(i);
                return true;
            case R.id.trivia_quiz:
                Intent intent = new Intent (Soal7Activity.this, SelamatdatangquizActivity.class);
                startActivity(intent);
                return true;
            case R.id.about:
                Intent ab = new Intent (Soal7Activity.this, AboutusActivity.class);
                startActivity(ab);
                return true;
            case R.id.Settings:
                Intent is = new Intent (Soal7Activity.this, SettingActivity.class);
                startActivity(is);
                return true;
            case R.id.sign_out:
                Intent in = new Intent (Soal7Activity.this, Masuk.class);
                startActivity(in);
                break;
    ...
    private void logout() {
        mAuth.signOut();
        startActivity(new Intent(Soal7Activity.this, Masuk.class));
        finish();
    }
    @Override
    ...
    public void tampilDialog() {
        ...
        builder.setMessage("Jawaban kamu benar : Daerah");
        builder.setPositiveButton("OKE", new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialogInterface, int i) {
                Toast.makeText(Soal7Activity.this, "Selamat", Toast.LENGTH_SHORT).show();
                Intent intent = new Intent(Soal7Activity.this, Soal8Activity.class);
                Soal7Activity.this.startActivity(intent);
            }
        });
    ...
    public void jawabanSalah(){
        ...
        builder.setPositiveButton("LEWATI", new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialogInterface, int i) {
                Toast.makeText(Soal7Activity.this, "Coba Lagi", Toast.LENGTH_SHORT).show();
                Intent intent = new Intent(Soal7Activity.this, Soal8Activity.class);
                Soal7Activity.this.startActivity(intent);
            }
        });
